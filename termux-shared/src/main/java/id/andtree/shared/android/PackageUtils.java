package id.andtree.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/id.andtree.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx id.andtree/10xxx}
             */
