package id.andtree.shared.activities;
...
import id.andtree.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="id.andtree.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="id.andtree.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
