package id.andtree.shared.termux.plugins;
...
import id.andtree.shared.R;
import id.andtree.shared.activities.ReportActivity;
import id.andtree.shared.file.FileUtils;
import id.andtree.shared.termux.file.TermuxFileUtils;
import id.andtree.shared.shell.command.result.ResultConfig;
import id.andtree.shared.shell.command.result.ResultData;
import id.andtree.shared.errors.Errno;
import id.andtree.shared.errors.Error;
import id.andtree.shared.notification.NotificationUtils;
import id.andtree.shared.termux.models.UserAction;
import id.andtree.shared.termux.notification.TermuxNotificationUtils;
import id.andtree.shared.termux.settings.preferences.TermuxPreferenceConstants;
import id.andtree.shared.shell.command.result.ResultSender;
import id.andtree.shared.shell.ShellUtils;
import id.andtree.shared.android.AndroidUtils;
...
import id.andtree.shared.termux.settings.preferences.TermuxPreferenceConstants.TERMUX_APP;
import id.andtree.shared.models.ReportInfo;
...
import id.andtree.shared.markdown.MarkdownUtils;
