...
import id.andtree.shared.termux.terminal.io.BellHandler;
import id.andtree.shared.logger.Logger;
import id.andtree.terminal.TerminalColors;
import id.andtree.terminal.TerminalSession;
import id.andtree.terminal.TerminalSessionClient;
import id.andtree.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {id.andtree/id.andtree.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
