package id.andtree.app.activities;
...
import id.andtree.shared.termux.settings.preferences.TermuxAPIAppSharedPreferences;
import id.andtree.shared.termux.settings.preferences.TermuxFloatAppSharedPreferences;
import id.andtree.shared.termux.settings.preferences.TermuxTaskerAppSharedPreferences;
import id.andtree.shared.termux.settings.preferences.TermuxWidgetAppSharedPreferences;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppCompatActivityUtils.setToolbar(this, id.andtree.shared.R.id.toolbar);
