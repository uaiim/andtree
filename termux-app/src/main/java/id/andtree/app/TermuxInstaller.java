...
import static id.andtree.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR;
import static id.andtree.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR_PATH;
import static id.andtree.shared.termux.TermuxConstants.TERMUX_STAGING_PREFIX_DIR;
import static id.andtree.shared.termux.TermuxConstants.TERMUX_STAGING_PREFIX_DIR_PATH;
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    // Create "Android/data/id.andtree" symlinks
                    ...
                    // Create "Android/media/id.andtree" symlinks
